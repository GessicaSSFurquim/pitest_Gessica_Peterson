...
private ConverteSegundos converte;
	...
	@Test
	public void deveRetornarMensagemDeErroSeNumeroMenorQueZero() {
			IllegalArgumentException exception = assertThrows(
					IllegalArgumentException.class,
					() -> {
						converte.converteSegundos(-1, -1, -1);
					}
			);

			assertEquals("Não existe numero negativo para tempo.", exception.getMessage());
		}
}
